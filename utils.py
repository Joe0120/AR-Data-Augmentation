...
def write_kitti_label(filename, bev_alpha, bbox_2D, material_info, bbox_3D_loc, bev_rotation_y):
    content = f"Car 0.00 0 {round(bev_alpha, 2)} {bbox_2D[0][0]} {bbox_2D[0][1]} {bbox_2D[1][0]} {bbox_2D[1][1]} {material_info['height']} {material_info['width']} {material_info['length']} {bbox_3D_loc[0]} {bbox_3D_loc[1]} {bbox_3D_loc[2]} {round(bev_rotation_y, 2)}"
...
P2: 689.6905 0.0 621.0 42.877 0.0 689.6905 187.5 -180 0.0 0.0 1.0 0.0027
